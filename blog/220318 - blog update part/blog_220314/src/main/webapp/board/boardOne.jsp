...
<div class = "container">
			...
			<ul class="list-group">
				...
				%>
						<li class = "list-group-item">
							<a href="<%=request.getContextPath()%>/boardList.jsp?categoryName=<%=m.get("categoryName")%>" ><%=m.get("categoryName")%> <span class = "badge bg-warning"><%=m.get("cnt")%></span> </a>
						</li>
				<%		
					}
				%>
	...
	<table class = "table table-info">
		...
		<div>
			<a href="<%=request.getContextPath()%>/updateBoardForm.jsp?boardNo=<%= board.boardNo %>" class = "btn btn-outline-info">수정</a>
			<a href="<%=request.getContextPath()%>/deleteBoardForm.jsp?boardNo=<%= board.boardNo %>" class = "btn btn-outline-info">삭제</a>
			<a href="<%=request.getContextPath()%>/boardList.jsp" class = "btn btn-outline-info">이전 페이지</a>
		</div>
	</div>
</div>
</body>
