...
%>
		...
		<div>
			<a href="<%= request.getContextPath() %>/photo/insertPhotoForm.jsp?photoNo=<%= p.photoNo %>" class = "btn btn-outline-dark">이미지 등록</a>
			<a href="<%= request.getContextPath() %>/photo/deletePhotoForm.jsp?photoNo=<%= p.photoNo %>" class = "btn btn-outline-dark">이미지 삭제</a>
		</div>
<%
	}
%>
